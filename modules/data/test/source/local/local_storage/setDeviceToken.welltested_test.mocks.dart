...
// in data/test/source/local/local_storage/setDeviceToken.welltested_test.dart.
...
import 'package:data/source/local/local_storage.dart' as _i5;
...
class MockLocalStorage extends _i1.Mock implements _i5.LocalStorage {
  ...
  @override
  _i3.Future<void> setLogin(bool? value) => (super.noSuchMethod(
        Invocation.method(
          #setLogin,
          [value],
        ),
  ...
  @override
  _i3.Future<void> setDeviceToken(String? deviceToken) => (super.noSuchMethod(
        Invocation.method(
          #setDeviceToken,
          [deviceToken],
        ),
