...
const fetchAllCarts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return apiResponse_1.default.success(res, "Cart fetch successfully", data);
    }
    catch (error) {
...
const addToCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return apiResponse_1.default.success(res, "Added to cart", data);
    }
    catch (error) {
        return apiResponse_1.default.internalServerError(res, apiResponseMessages_1.default.anErrorOccurred, error);
    }
...
const updateCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (quantity === 0) {
            ...
            return apiResponse_1.default.success(res, "Deleted from cart", data);
        }
        else {
            const data = yield di_1.cartService.updateQuantity(userId, productId, quantity);
            return apiResponse_1.default.success(res, "Cart Updated", data);
        }
    }
    catch (error) {
        return apiResponse_1.default.internalServerError(res, apiResponseMessages_1.default.anErrorOccurred, error);
