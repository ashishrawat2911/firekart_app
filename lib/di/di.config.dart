...
import '../core/global_listener/global_listener.dart' as _i12;
import '../core/utils/validator.dart' as _i27;
import '../data/crashlytics/crashlytics_service.dart' as _i33;
...
import '../domain/usecases/logout_usecase.dart' as _i13;
import '../domain/usecases/place_order_usecase.dart' as _i16;
import '../domain/usecases/sample_use_case.dart' as _i26;
import '../domain/usecases/search_products_use_case.dart' as _i20;
...
import '../domain/usecases/stream_account_details_usecase.dart' as _i25;
...
import '../presentation/features/add_address/view_model/add_address_view_model.dart'
    as _i29;
import '../presentation/features/cart/view_model/cart_view_model.dart' as _i31;
...
import '../presentation/features/dashboard/view_model/dashboard_view_model.dart'
    as _i34;
import '../presentation/features/home/viewmodel/home_viewmodel.dart' as _i35;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt $initGetIt({
    ...
    gh.singleton<_i12.GlobalListener>(_i12.GlobalListenerImpl());
    gh.factory<_i13.LogoutUseCase>(
        () => _i13.LogoutUseCase(get<_i3.FirebaseRepository>()));
    ...
    gh.factory<_i16.PlaceOrderUseCase>(
        () => _i16.PlaceOrderUseCase(get<_i3.FirebaseRepository>()));
    ...
    gh.factory<_i19.ProductViewModel>(() => _i19.ProductViewModel(
    ...
    gh.factory<_i20.SearchProductsUseCase>(
        () => _i20.SearchProductsUseCase(get<_i3.FirebaseRepository>()));
    ...
    gh.factory<_i25.StreamAccountDetailsUseCaseUseCase>(() =>
        _i25.StreamAccountDetailsUseCaseUseCase(get<_i3.FirebaseRepository>()));
    gh.factory<_i26.UseCase>(() => _i26.UseCase());
    gh.singleton<_i27.Validator>(_i27.Validator());
    gh.factory<_i28.AddAccountDetailsViewModel>(
        () => _i28.AddAccountDetailsViewModel(
    ...
    gh.factory<_i29.AddAddressViewModel>(
        () => _i29.AddAddressViewModel(get<_i22.SetAccountDetailsUseCase>()));
    gh.factory<_i30.AllProductCubit>(
        () => _i30.AllProductCubit(get<_i6.GetAllProductsUseCase>()));
    gh.factory<_i31.CartViewModel>(() => _i31.CartViewModel(
          get<_i12.GlobalListener>(),
          get<_i17.ProductAddToCartUseCase>(),
          get<_i18.ProductDeleteCartUseCase>(),
          get<_i16.PlaceOrderUseCase>(),
        ));
    gh.factory<_i32.CheckStatusViewModel>(() => _i32.CheckStatusViewModel(
          get<_i11.GetUserLoggedInStatusUseCase>(),
          get<_i10.GetUserDataStatusUseCase>(),
        ));
    gh.singleton<_i33.CrashlyticsService>(_i33.CrashlyticsService(
      get<_i10.GetUserDataStatusUseCase>(),
      get<_i3.FirebaseRepository>(),
    ));
    gh.factory<_i34.DashboardViewModel>(
        () => _i34.DashboardViewModel(get<_i6.GetAllProductsUseCase>()));
    gh.factory<_i35.HomeScreenViewModel>(() => _i35.HomeScreenViewModel(
          get<_i12.GlobalListener>(),
          get<_i7.GetCartStatusUseCase>(),
          get<_i25.StreamAccountDetailsUseCaseUseCase>(),
        ));
    ...
    gh.factory<_i37.OtpLoginViewModel>(
        () => _i37.OtpLoginViewModel(get<_i21.SendOTPUseCase>()));
    gh.factory<_i38.ProductSearchViewModel>(
        () => _i38.ProductSearchViewModel(get<_i20.SearchProductsUseCase>()));
    return this;
  }
}
