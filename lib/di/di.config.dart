...
import 'package:firekart/data/repository/auth_repository.dart' as _i37;
import 'package:firekart/data/repository/cart_repository.dart' as _i39;
import 'package:firekart/data/repository/order_repository.dart' as _i45;
import 'package:firekart/data/repository/product_repository.dart' as _i50;
import 'package:firekart/data/repository/user_repository.dart' as _i55;
...
import 'package:firekart/di/module/firebase_module.dart' as _i75;
import 'package:firekart/di/module/network_module.dart' as _i76;
import 'package:firekart/di/module/storage_module.dart' as _i77;
import 'package:firekart/domain/repository/auth_repository.dart' as _i36;
import 'package:firekart/domain/repository/cart_repository.dart' as _i38;
import 'package:firekart/domain/repository/order_repository.dart' as _i44;
import 'package:firekart/domain/repository/product_repository.dart' as _i49;
import 'package:firekart/domain/repository/user_repository.dart' as _i54;
import 'package:firekart/domain/usecases/add_address_usecase.dart' as _i56;
import 'package:firekart/domain/usecases/add_product_to_cart_usecase.dart'
    as _i47;
import 'package:firekart/domain/usecases/cart_usecase.dart' as _i40;
import 'package:firekart/domain/usecases/delete_product_from_cart_usecase.dart'
    as _i48;
import 'package:firekart/domain/usecases/edit_address_usecase.dart' as _i58;
import 'package:firekart/domain/usecases/get_account_details_usecase.dart'
    as _i59;
import 'package:firekart/domain/usecases/get_address_usecase.dart' as _i60;
import 'package:firekart/domain/usecases/get_all_orders_usecase.dart' as _i61;
import 'package:firekart/domain/usecases/get_all_product_usecase.dart' as _i62;
import 'package:firekart/domain/usecases/get_cart_status_use_case.dart' as _i41;
...
import 'package:firekart/domain/usecases/get_user_logged_in_status.dart'
    as _i42;
import 'package:firekart/domain/usecases/logout_usecase.dart' as _i43;
...
import 'package:firekart/domain/usecases/search_products_use_case.dart' as _i51;
import 'package:firekart/domain/usecases/send_otp_usecase.dart' as _i52;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i40.CartUseCase>(_i40.CartUseCase(gh<_i38.CartRepository>()));
    gh.factory<_i41.GetCartStatusUseCase>(
        () => _i41.GetCartStatusUseCase(gh<_i38.CartRepository>()));
    gh.factory<_i42.GetUserLoggedInStatusUseCase>(
        () => _i42.GetUserLoggedInStatusUseCase(gh<_i36.AuthRepository>()));
    gh.factory<_i43.LogoutUseCase>(
        () => _i43.LogoutUseCase(gh<_i36.AuthRepository>()));
    gh.factory<_i44.OrderRepository>(() => _i45.OrderRepositoryImpl(
          gh<_i7.DataMapper>(),
          gh<_i35.ApiService>(),
        ));
    gh.factory<_i46.PlaceOrderUseCase>(
        () => _i46.PlaceOrderUseCase(gh<_i44.OrderRepository>()));
    gh.factory<_i47.ProductAddToCartUseCase>(
        () => _i47.ProductAddToCartUseCase(gh<_i38.CartRepository>()));
    gh.factory<_i48.ProductDeleteCartUseCase>(
        () => _i48.ProductDeleteCartUseCase(gh<_i38.CartRepository>()));
    gh.factory<_i49.ProductRepository>(() => _i50.ProductRepositoryImpl(
          gh<_i7.DataMapper>(),
          gh<_i35.ApiService>(),
        ));
    gh.factory<_i51.SearchProductsUseCase>(
        () => _i51.SearchProductsUseCase(gh<_i49.ProductRepository>()));
    gh.factory<_i52.SendOTPUseCase>(
        () => _i52.SendOTPUseCase(gh<_i36.AuthRepository>()));
    gh.factory<_i53.UpdateCartUseCase>(
        () => _i53.UpdateCartUseCase(gh<_i38.CartRepository>()));
    gh.factory<_i54.UserRepository>(() => _i55.UserRepositoryImpl(
          gh<_i7.DataMapper>(),
          gh<_i35.ApiService>(),
        ));
    gh.factory<_i56.AddAddressUseCase>(
        () => _i56.AddAddressUseCase(gh<_i54.UserRepository>()));
    gh.factory<_i57.CheckStatusViewModel>(() =>
        _i57.CheckStatusViewModel(gh<_i42.GetUserLoggedInStatusUseCase>()));
    gh.factory<_i58.EditAddressUseCase>(
        () => _i58.EditAddressUseCase(gh<_i54.UserRepository>()));
    gh.factory<_i59.GetAccountDetailsUseCase>(
        () => _i59.GetAccountDetailsUseCase(gh<_i54.UserRepository>()));
    gh.factory<_i60.GetAddressUseCase>(
        () => _i60.GetAddressUseCase(gh<_i54.UserRepository>()));
    gh.factory<_i61.GetAllOrdersUseCase>(
        () => _i61.GetAllOrdersUseCase(gh<_i44.OrderRepository>()));
    gh.factory<_i62.GetAllProductsUseCase>(
        () => _i62.GetAllProductsUseCase(gh<_i49.ProductRepository>()));
    gh.factory<_i63.MyAddressViewModel>(() => _i63.MyAddressViewModel(
          gh<_i59.GetAccountDetailsUseCase>(),
          gh<_i22.SetAccountDetailsUseCase>(),
          gh<_i60.GetAddressUseCase>(),
          gh<_i58.EditAddressUseCase>(),
        ));
    gh.factory<_i64.MyOrdersCubit>(
        () => _i64.MyOrdersCubit(gh<_i61.GetAllOrdersUseCase>()));
    gh.factory<_i65.OtpLoginViewModel>(
        () => _i65.OtpLoginViewModel(gh<_i52.SendOTPUseCase>()));
    gh.factory<_i66.ProductSearchViewModel>(
        () => _i66.ProductSearchViewModel(gh<_i51.SearchProductsUseCase>()));
    gh.factory<_i67.ProductViewModel>(() => _i67.ProductViewModel(
          gh<_i15.GetItemsInCartUseCase>(),
          gh<_i47.ProductAddToCartUseCase>(),
          gh<_i41.GetCartStatusUseCase>(),
          gh<_i53.UpdateCartUseCase>(),
        ));
    gh.factory<_i68.StreamAccountDetailsUseCaseUseCase>(() =>
        _i68.StreamAccountDetailsUseCaseUseCase(gh<_i54.UserRepository>()));
    gh.factory<_i69.AddAccountDetailsViewModel>(
        () => _i69.AddAccountDetailsViewModel(
              gh<_i22.SetAccountDetailsUseCase>(),
              gh<_i59.GetAccountDetailsUseCase>(),
            ));
    gh.factory<_i70.AddAddressViewModel>(() => _i70.AddAddressViewModel(
          gh<_i56.AddAddressUseCase>(),
          gh<_i58.EditAddressUseCase>(),
        ));
    gh.factory<_i71.AllProductCubit>(
        () => _i71.AllProductCubit(gh<_i62.GetAllProductsUseCase>()));
    ...
    gh.factory<_i73.DashboardViewModel>(
        () => _i73.DashboardViewModel(gh<_i62.GetAllProductsUseCase>()));
    gh.factory<_i74.HomeScreenViewModel>(() => _i74.HomeScreenViewModel(
          gh<_i41.GetCartStatusUseCase>(),
          gh<_i68.StreamAccountDetailsUseCaseUseCase>(),
          gh<_i60.GetAddressUseCase>(),
...
class _$StorageModule extends _i77.StorageModule {}
