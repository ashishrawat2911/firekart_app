...
class _$HomeStateTearOff {
  ...
  _HomeState call({int bottomIndex = 0, int noOfItemsInCart = 0, AccountDetails? accountDetails}) {
    return _HomeState(
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({int bottomIndex, int noOfItemsInCart, AccountDetails? accountDetails}) = _$_HomeState;
