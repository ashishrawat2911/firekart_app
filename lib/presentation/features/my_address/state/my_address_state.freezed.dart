...
class _$AddressCardStateTearOff {
  ...
  _AddressCardState call(
      {int index = 0, required AddressModel address, bool editLoading = false, bool setDefaultLoading = false}) {
...
abstract class $AddressCardStateCopyWith<$Res> {
  ...
  $Res call({int index, AddressModel address, bool editLoading, bool setDefaultLoading});
}
...
abstract class _AddressCardState implements AddressCardState {
  const factory _AddressCardState(
      {int index, required AddressModel address, bool editLoading, bool setDefaultLoading}) = _$_AddressCardState;
